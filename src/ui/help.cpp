...
const Line kLines[] = {
    ...
    {"SOUND > Randomize rolls a new one (hear", false},
    {"it instantly), Mutate evolves it, Undo", false},
    ...
    {"MAKE A SOUND (settings > SOUND)", true},
    {"Randomize: roll a whole new patch in", false},
    {"one tap; it auditions instantly. Roll", false},
    {"till you love one.", false},
    {"Mutate: evolve THIS sound a little or", false},
