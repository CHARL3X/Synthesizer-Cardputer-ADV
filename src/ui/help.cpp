...
const Line kLines[] = {
    ...
    {"SOUNDS: 1 LIVE SOUND + 10 SLOTS", true},
    {"You always edit ONE live sound.", false},
    {"fn + number row : 10 live knobs", false},
    {"   then [ ] fine,  - = coarse", false},
    {"fn + q..p       : load a saved sound", false},
    ...
    {"Settings > SOUND > Randomize builds a", false},
    {"whole new patch in ONE tap - a happy-", false},
    {"accident machine. Love it? fn+shift+q", false},
    {"to keep it. Don't? fn+q reloads your", false},
    {"saved sound. It can't break anything.", false},
    {"Init = the opposite: a blank sound to", false},
    {"build from scratch. Filter mode and", false},
    {"Sound reset (->factory) live here too.", false},
